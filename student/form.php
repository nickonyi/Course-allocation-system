...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO student_applications(first_name,last_name,date,phone_no,email,city,county,p_box,location,gender,course_category,course_name) VALUES('$firstname','$lastname','$date','$contact','$email','$city','$county','$pbox','$location','$gender','$coursecateg','$coursename')";
        ...
        ?>
            ...
            <div class="form">
                ...
                <div class="flex-form">
                    ...
                    $result = mysqli_query($conn,$sql); 
                    ?>
                    <select class="form-box form-letter" name="course-name" id="course-name">
